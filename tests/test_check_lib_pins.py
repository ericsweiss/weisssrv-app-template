...
Plus a smoke check that this repository's REAL .gitlab-ci.yml passes.
test_ci_shapes.py extends the same invariant to the pins this gate cannot see:
the python-tests LIB_REF and the two wrapper-script defaults.
"""
